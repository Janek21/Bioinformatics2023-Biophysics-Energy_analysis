#STEP 1: Determine amino acid residues that form the interface between the complex components.
...
distance_threshold = 7.0  # Change this value based on your visual inspection
